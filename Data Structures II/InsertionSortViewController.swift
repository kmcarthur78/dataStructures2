...
//  Data Structures II
//
//  Created by Kelsey McArthur on 2/8/19.
...
class InsertionSortViewController: UIViewController {
    ...
    @IBOutlet weak var listInput: UILabel!
    ...
    @IBAction func sortButton(_ sender: Any) {
        let listString = insertionSort(list)
        listResult.text = "\(listString)"
    }
    
    override func viewDidLoad() {
        super.viewDidLoad()
        //GIF
        let gifURL : String = "https://i.imgur.com/YETkspD.gif"
